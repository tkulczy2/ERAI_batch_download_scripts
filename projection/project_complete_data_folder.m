function [Q] = project_complete_data_folder(s,a,label,density,latlim,lonlim,varargin)
...
project_weather_data_folder(s,a,label,'weather_data');
...
fprintf(fid,[' '  '\n']);
fprintf(fid,['// THIS FILE GENERATED BY: project_complete_data_folder.m'  '\n']);
