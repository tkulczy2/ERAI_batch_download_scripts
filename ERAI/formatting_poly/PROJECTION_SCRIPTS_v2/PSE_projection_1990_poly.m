...
% Sol's machine
%cd /Users/solhsiang/Dropbox/Rhodium/summer-workshop-data/_spatial_data/PSE

% Tamma - Shackleton: call shapefiles stored on Norgay
cd '/mnt/norgay/Datasets/SHAPEFILES/PSE/PSE_adm'

[s,a] = shaperead('PSE_adm2.shp','UseGeoCoords', true) 
a = combine_attributes(a, 'NAME_1', 'NAME_2');

cd '/mnt/norgay/Datasets/Climate/Berkeley_Earth/Matlab_projected_DAILY_polynomials'
mkdir PSE_daily_BEST_polynomials
cd PSE_daily_BEST_polynomials
label = 'NAME_1_NAME_2';

%obtain BEST data file for relevant decade
sample_first_year = 1990;


% Sol's machine
%load '/Volumes/Disk 1 RAID Set/LARGE_DATASETS/Berkeley_Earth/Matlab_1deg_x_1deg_polynomials/TAVG/tavg_1990_raw_polynomials'
%load '/Volumes/Disk 1 RAID Set/LARGE_DATASETS/Berkeley_Earth/Matlab_1deg_x_1deg_polynomials/TMAX/tmax_1990_raw_polynomials'
%load '/Volumes/Disk 1 RAID Set/LARGE_DATASETS/Berkeley_Earth/Matlab_1deg_x_1deg_polynomials/TMIN/tmin_1990_raw_polynomials'

% Tamma-Shackleton
load '/mnt/norgay/Datasets/Climate/Berkeley_Earth/Matlab_1deg_x_1deg_polynomials/TAVG/tavg_1990_raw_polynomials'
load '/mnt/norgay/Datasets/Climate/Berkeley_Earth/Matlab_1deg_x_1deg_polynomials/TMAX/tmax_1990_raw_polynomials'
load '/mnt/norgay/Datasets/Climate/Berkeley_Earth/Matlab_1deg_x_1deg_polynomials/TMIN/tmin_1990_raw_polynomials'
