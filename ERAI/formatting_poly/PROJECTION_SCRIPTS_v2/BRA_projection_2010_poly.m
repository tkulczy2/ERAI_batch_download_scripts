...
% PROJECTING DAILY TEMPERATURE AND PRECIPITATION DATA FROM ERA-INTERIM FOR 
% BRA ADM 2, 2010-2013
...
mkdir BRA_daily_ERAI_polynomials
cd BRA_daily_ERAI_polynomials
label = 'NAME_1_NAME_2';
...
T = 4 % 1 is tavg, 2 is tmax, 3 is tmin, 4 is precip
