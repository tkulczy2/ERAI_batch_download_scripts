...
cd '/mnt/norgay/Datasets/SHAPEFILES/NLD/NLD_adm'
...
mkdir NLD_daily_BEST_polynomials
cd NLD_daily_BEST_polynomials
label = 'NAME_1';

%obtain BEST data file for relevant decade

sample_first_year = 1970;

% Sol's machine
%load '/Volumes/Disk 1 RAID Set/LARGE_DATASETS/Berkeley_Earth/Matlab_1deg_x_1deg_polynomials/TAVG/tavg_1970_raw_polynomials'
%load '/Volumes/Disk 1 RAID Set/LARGE_DATASETS/Berkeley_Earth/Matlab_1deg_x_1deg_polynomials/TMAX/tmax_1970_raw_polynomials'
%load '/Volumes/Disk 1 RAID Set/LARGE_DATASETS/Berkeley_Earth/Matlab_1deg_x_1deg_polynomials/TMIN/tmin_1970_raw_polynomials'

% Tamma-Shackleton
load '/mnt/norgay/Datasets/Climate/Berkeley_Earth/Matlab_1deg_x_1deg_polynomials/TAVG/tavg_1970_raw_polynomials'
load '/mnt/norgay/Datasets/Climate/Berkeley_Earth/Matlab_1deg_x_1deg_polynomials/TMAX/tmax_1970_raw_polynomials'
load '/mnt/norgay/Datasets/Climate/Berkeley_Earth/Matlab_1deg_x_1deg_polynomials/TMIN/tmin_1970_raw_polynomials'
