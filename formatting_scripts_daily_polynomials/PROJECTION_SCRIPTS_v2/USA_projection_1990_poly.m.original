...
% Sol's machine
%cd /Users/solhsiang/Dropbox/Rhodium/summer-workshop-data/_spatial_data/USA
% Tamma - Shackleton: call shapefiles stored on Norgay
cd '/mnt/norgay/Datasets/SHAPEFILES/USA/USA_adm'

[s,a] = shaperead('USA_adm2.shp','UseGeoCoords', true) 
a = combine_attributes(a, 'NAME_1', 'NAME_2');

cd '/mnt/norgay/Datasets/Climate/Berkeley_Earth/Matlab_projected_DAILY_polynomials'
mkdir USA_daily_BEST_polynomials
cd USA_daily_BEST_polynomials
label = 'NAME_1_NAME_2';
