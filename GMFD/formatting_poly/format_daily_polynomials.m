...
close all
clc
diary('output_gmfd_precip_.25deg.txt')
%% SET UP
...
mkdir([tempdir '/' clim '/Matlab_.25deg_x_.25deg_polynomials/PRCP'])
...
%         command = ['save ' tempdir '/' clim 'l/Matlab_.25deg_x_.25deg_polynomials/' VAR '/' varyear '_raw_polynomials -v7.3'];
%         eval(command)
